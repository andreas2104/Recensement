// app/persons/create/page.tsx
'use client';

import { useState } from 'react';
import { useRouter } from 'next/navigation';
import { Form, EncType } from '@/components/Form';
...
export default function CreatePersonPage() {
  ...
  const handleSuccess = async (res: Response) => {
    if (res.ok) {
      ...
      // Rediriger vers la liste ou détail
      router.push('/persons');
      router.refresh();
    }
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        <div className="bg-white shadow rounded-lg p-6 space-y-6">
          ...
          {/* CIN et identification */}
          <div className="border-b pb-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Carte d'Identité Nationale</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <label htmlFor="issuePlace" className="block text-sm font-medium text-gray-700 mb-2">
                  Lieu de délivrance *
                </label>
                <input
                  type="text"
